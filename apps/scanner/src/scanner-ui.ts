 ...
 */
export const GRADE = {
  critical: { fg: "#FF6469", bg: "#1E1417", line: "#4A2328", glyph: "!" },
  warning: { fg: "#F2A33C", bg: "#1E1811", line: "#463519", glyph: "▲" },
  info: { fg: "#55C97A", bg: "#131E17", line: "#25422F", glyph: "✓" },
} as const;
 ...
 * Nothing floats.
 *
 * A drop shadow on a flat near-black surface does not read as depth, it reads
 * as smudge. Separation comes from the border and the ground colour instead,
 * which is what makes the whole thing look engineered rather than decorated.
 */
export const lift = {} as object;
