...
const WARMUP = [
  ...
  m("arm-circles", L("Shoulder circles", "تدوير الأكتاف"), { seconds: 30 }, 10,
    [L("Extend your arms out to the sides", "افردي ذراعيك على الجانبين"), L("Small circles forward for 15 seconds", "دوّري دوائر صغيرة للأمام ١٥ ثانية"), L("Then backward for 15 seconds", "بعدين للورا ١٥ ثانية")],
...
const CORE = [
  m("dead-bug", L("Dead bug", "الحشرة الميتة"), { reps: 12 }, 30,
    [L("Lie on your back, arms up, knees bent to 90 degrees", "استلقي على ظهرك، الذراعين لفوق والركبتين مثنيتين ٩٠ درجة"),
...
const LOWER = [
  ...
  m("lunge", L("Reverse lunge", "الطعن"), { reps: 12 }, 40,
    [L("Take a long step backward with one leg", "خطوة كبيرة للورا برجل وحدة"),
     L("Lower until both knees reach 90 degrees", "انزلي لحد ما الركبتين ٩٠ درجة"),
  ...
  m("wall-sit", L("Wall sit", "القعدة على الحائط"), { seconds: 40 }, 40,
    [L("Lean your back on the wall and slide into a seated position", "استندي بظهرك على الحائط وانزلي لوضعية القعود"),
     L("Thighs parallel to the floor, knees at 90 degrees", "الفخذ موازي للأرض والركبة ٩٠ درجة"),
     L("Keep your whole back flat against the wall", "الظهر ملتصق بالحائط تماماً")],
    [L("Not sinking to 90 degrees", "النزول أقل من ٩٠ درجة"), L("Resting your hands on your thighs", "الاستناد باليدين على الفخذين")]),
...
const UPPER = [
  m("knee-pushup", L("Knee push-up", "ضغط على الركبتين"), { reps: 10 }, 40,
    ...
    [L("Letting the hips sag", "نزول الحوض"), L("Flaring the elbows out to 90 degrees — this strains the shoulder", "فتح المرفقين ٩٠ درجة عن الجسم — بيأذي الكتف")]),
...
export const womensfit: ProgramPack = {
  ...
  onboarding: [
    ...
    { key: "time", question: L("How much time do you have a day?", "قديش وقتك باليوم؟"),
      options: [L("10 minutes", "١٠ دقايق"), L("15–20 minutes", "١٥–٢٠ دقيقة"), L("Half an hour or more", "نص ساعة أو أكثر")] },
  ...
  paywall: {
    ...
    bullets: [
      L("10 full workouts, 10 to 25 minutes each", "١٠ تمارين كاملة من ١٠ لـ ٢٥ دقيقة"),
  ...
  plan: { weeks: 4, daysPerWeek: 4, promise: L("Four weeks, four times a week, 10 to 25 minutes", "أربع أسابيع، أربع مرات بالأسبوع، من ١٠ لـ ٢٥ دقيقة") },
  sessions: WOMENSFIT_SESSIONS,
  tips: [
    L("Consistency beats intensity. Ten minutes daily does more than one hour a week.", "الالتزام أهم من الشدة. تمرين ١٠ دقايق كل يوم أفضل من ساعة مرة بالأسبوع."),
    ...
    L("Under six hours of sleep erases most of what training gives you.", "النوم أقل من ٦ ساعات بيوقف نتايج التمرين تقريباً."),
  ],
};
